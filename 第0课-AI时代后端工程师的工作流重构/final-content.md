...
- 对应练习：[`../课后练习/第0课/练习.md`](../课后练习/第0课/练习.md)
  这里把本课练习细化成准备材料、三档题目、交付物和验收点，适合作为整套课程的第一份执行样板。
...
建议直接在 [`../课后练习/第0课/练习.md`](../课后练习/第0课/练习.md) 中完成本课练习，并使用 [`../课后练习/通用提交模板.md`](../课后练习/通用提交模板.md) 保留 AI 输入、人工删改和验证结果。
